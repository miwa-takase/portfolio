...
const btnPrimary =
  "inline-flex items-center gap-2 rounded-full border border-accent bg-accent px-5 py-2 text-sm font-semibold tracking-wide text-ink transition-all hover:bg-accent-soft";
const btnGhost =
